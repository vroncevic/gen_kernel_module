...
Info
    Validator for the gen_kernel_module bundle dependencies.
'''
...
class GenKernelModuleBundleDependenciesValidator:
    '''
        Validator for the gen_kernel_module bundle dependencies.
    ...
    @classmethod
    def validate(cls, dependencies: GenKernelModuleBundleDependencies) -> None:
        '''
            Validates the gen_kernel_module bundle dependencies.

            :param dependencies: The gen_kernel_module bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_kernel_module_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_kernel_module bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_kernel_module bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenKernelModuleBundleKeys.get_dependency_to_type().items():
