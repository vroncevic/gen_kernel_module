...
Info
    GenKernelModule bundle options for the gen_kernel_module bundle.
'''
...
class GenKernelModuleBundleOptions(TypedDict):
    '''
        GenKernelModule bundle options for the gen_kernel_module bundle.
        ...
        It defines:
            ...
            :attributes:
                | info_file - The info file path for the gen_kernel_module bundle.
    '''
