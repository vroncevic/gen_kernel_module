...
Info
    A validator for the gen_kernel_module bundle.
'''
...
class GenKernelModuleBundleValidator:
    '''
        A validator for the gen_kernel_module bundle.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_kernel_module bundle.
                | is_valid - Checks if the gen_kernel_module bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: GenKernelModuleBundle) -> None:
        '''
            Validates the gen_kernel_module bundle.

            :param bundle: The gen_kernel_module bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_kernel_module_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_kernel_module bundle must be provided'
        msg_bundle_istype: str = 'the gen_kernel_module bundle must be an instance of GenKernelModuleBundle'
        ...
        istype(bundle, GenKernelModuleBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, genkernelmodulebundle: GenKernelModuleBundle) -> bool:
        '''
            Checks if the genkernelmodulebundle is valid.

            :param genkernelmodulebundle: The genkernelmodulebundle to be checked.
            :return: True if valid, False otherwise.
        '''
        try:
            cls.validate(genkernelmodulebundle)
            return True
