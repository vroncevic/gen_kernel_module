...
setup(
    ...
    package_data={
        'gen_kernel_module': [
            ...
            f'{CONF}/project.yaml',
            f'{TEMPLATE}/lkm_block_device/lkm.template',
            f'{TEMPLATE}/lkm_block_device/Makefile.template',
            f'{TEMPLATE}/lkm_block_device/test.template',
            f'{TEMPLATE}/lkm_charachter_device/lkm.template',
            f'{TEMPLATE}/lkm_charachter_device/Makefile.template',
            f'{TEMPLATE}/lkm_charachter_device/test.template',
            f'{TEMPLATE}/lkm_network_interfaces/lkm.template',
            f'{TEMPLATE}/lkm_network_interfaces/Makefile.template',
            f'{TEMPLATE}/lkm_network_interfaces/test.template',
            f'{TEMPLATE}/lkm_vma/lkm.template',
            f'{TEMPLATE}/lkm_vma/Makefile.template',
            f'{TEMPLATE}/lkm_vma/test.template',
